...
// The TCB is a structure that contains the thread's stack pointer, the thread's id, and the thread's priority and other information
// TCBptr is a pointer to a TCB
typedef struct tcb TCB;
typedef TCB *TCBptr;
 ...
 * 
 * @param: task - the thread to be added
 * 
 ...
 * *                   addThreadPriority
 * 
 *  @brief: Adds a thread to the priority list
 * 
 * @param: thread - the thread to be added
 * 
 * @return: none
 * 
 * @note: This function is called by OS_AddThread
 * 
 *=============================================**/
...
/**==============================================
 * *                   removeThreadPriority
 * 
 * @brief: Removes a thread from the priority list
 * 
 * @param: thread - the thread to be removed
 * 
 * @return: none
 * 
 * @note: This function is called by OS_KillThread
 * 
 *=============================================**/
...
/**==============================================
 * *                   getNextPriorityThreadAndUpdateList
 * 
 *  @brief: Gets the next thread to be run from the priority list
 * 
 * @param: none
 * 
 * @return: the next thread to be run
 * 
 * @note: This function is called by OS_SuspendThread
 * 
 *=============================================**/
...
/**========================================================================
 **                           Scheduler
 *?  @brief: This function is the scheduler for the OS. It is called by the PendSV_Handler
 *@param void     
 *@return void
 *========================================================================**/
void Scheduler(void);
